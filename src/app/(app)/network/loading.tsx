export default function LoadingNetwork() {
  return (
    <div className="space-y-6">
      <div className="h-36 animate-pulse rounded-lg border border-slate-800 bg-slate-900" />
      <div className="grid gap-4 md:grid-cols-3">
        <div className="h-56 animate-pulse rounded-lg border border-slate-800 bg-slate-900 md:col-span-2" />
