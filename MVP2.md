# Quantidive - Living Research Profile

> **What this is:** a running record of what Quantidive does today and the plan to take it
...
| Quantidive dashboard | done | **Research view** and **Trader metrics view** ([trust.ts](src/lib/trust.ts)): Big-Win Dependency, Biggest-Drop severity, Bounce-Back Time, sub-scores + Transparency Score + verdict |
