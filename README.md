...
truSVAN combines trader verification with a diligence workspace and verified discussion network
...
- Discord/community access should eventually use OAuth/linked roles so truSVAN can expose proof-level metadata without manually granting chat permissions.
...
Demo after seeding: `/p/demo`, login `demo@trusvan.local` / `demo1234`. The seed also
